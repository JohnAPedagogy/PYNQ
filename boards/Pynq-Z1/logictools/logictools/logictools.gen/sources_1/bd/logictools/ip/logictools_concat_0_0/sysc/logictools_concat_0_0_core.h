...
#ifndef _logictools_concat_0_0_core_h_
#define _logictools_concat_0_0_core_h_
...
class logictools_concat_0_0_core : public sc_module 
{
    public: 
       logictools_concat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(logictools_concat_0_0_core);
    ...
    virtual ~logictools_concat_0_0_core() = default;
   
    void concate_input_port_values()
    {
        sc_bv <24> portConcateVal;
