...
#ifndef _logictools_func_sel_concat_0_core_h_
#define _logictools_func_sel_concat_0_core_h_
...
class logictools_func_sel_concat_0_core : public sc_module 
{
    public: 
       logictools_func_sel_concat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(logictools_func_sel_concat_0_core);
    ...
    virtual ~logictools_func_sel_concat_0_core() = default;
