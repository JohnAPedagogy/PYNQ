...
localparam
    ...
    ADDR_IER             = 6'h08,
    ADDR_ISR             = 6'h0c,
    ADDR_TRIGGER_DATA_0  = 6'h10,
    ADDR_TRIGGER_DATA_1  = 6'h14,
    ADDR_TRIGGER_CTRL    = 6'h18,
        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_TRIGGER_DATA_0: begin
                    rdata <= int_trigger[31:0];
                end
                ADDR_TRIGGER_DATA_1: begin
                    rdata <= int_trigger[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_TRIGGER_DATA_0)
            int_trigger[31:0] <= (WDATA[31:0] & wmask) | (int_trigger[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_TRIGGER_DATA_1)
            int_trigger[63:32] <= (WDATA[31:0] & wmask) | (int_trigger[63:32] & ~wmask);
    end
end
