...
// Command     : write_verilog -force -mode synth_stub -rename_top base_axi_interconnect_0_imp_auto_cc_1 -prefix
//               base_axi_interconnect_0_imp_auto_cc_1_ base_axi_interconnect_0_imp_auto_cc_2_stub.v
...
(* CHECK_LICENSE_TYPE = "base_axi_interconnect_0_imp_auto_cc_2,axi_clock_converter_v2_1_34_axi_clock_converter,{}" *) (* CORE_GENERATION_INFO = "base_axi_interconnect_0_imp_auto_cc_2,axi_clock_converter_v2_1_34_axi_clock_converter,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_clock_converter,x_ipVersion=2.1,x_ipCoreRevision=34,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_AXI_ID_WIDTH=1,C_AXI_ADDR_WIDTH=7,C_AXI_DATA_WIDTH=32,C_S_AXI_ACLK_RATIO=1,C_M_AXI_ACLK_RATIO=2,C_AXI_IS_ACLK_ASYNC=1,C_AXI_PROTOCOL=2,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_AXI_SUPPORTS_WRITE=1,C_AXI_SUPPORTS_READ=1,C_SYNCHRONIZER_STAGE=3}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "axi_clock_converter_v2_1_34_axi_clock_converter,Vivado 2025.1" *) 
module base_axi_interconnect_0_imp_auto_cc_1(s_axi_aclk, s_axi_aresetn, s_axi_awaddr, 
