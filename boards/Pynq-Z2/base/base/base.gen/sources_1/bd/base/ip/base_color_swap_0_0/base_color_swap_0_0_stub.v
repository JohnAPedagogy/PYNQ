...
//               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_color_swap_0_0/base_color_swap_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "base_color_swap_0_0,color_swap,{}" *) (* CORE_GENERATION_INFO = "base_color_swap_0_0,color_swap,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=color_swap,x_ipVersion=1.1,x_ipCoreRevision=3,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,input_format=rbg,output_format=rgb}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
