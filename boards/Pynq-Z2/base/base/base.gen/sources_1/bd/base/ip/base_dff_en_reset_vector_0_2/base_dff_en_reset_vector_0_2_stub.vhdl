...
entity base_dff_en_reset_vector_0_2 is
  ...
  attribute CHECK_LICENSE_TYPE of base_dff_en_reset_vector_0_2 : entity is "base_dff_en_reset_vector_0_0,dff_en_reset_vector,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of base_dff_en_reset_vector_0_2 : entity is "base_dff_en_reset_vector_0_0,dff_en_reset_vector,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=dff_en_reset_vector,x_ipVersion=1.0,x_ipCoreRevision=3,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,SIZE=1,DELAY=3}";
