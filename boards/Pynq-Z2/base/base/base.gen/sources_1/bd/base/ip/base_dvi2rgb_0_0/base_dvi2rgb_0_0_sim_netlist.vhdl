...
-- Date        : Sun Sep 21 17:02:45 2025
-- Host        : GI240817-JohnAlamina running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_dvi2rgb_0_0/base_dvi2rgb_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of base_dvi2rgb_0_0_ChannelBond is
  ...
  attribute SOFT_HLUTNM of \pDataIn[0]_i_4__0\ : label is "soft_lutpair61";
  ...
  attribute SOFT_HLUTNM of \pDataIn[3]_i_2__0\ : label is "soft_lutpair58";
  ...
  attribute SOFT_HLUTNM of \pDataIn[5]_i_3\ : label is "soft_lutpair62";
...
entity base_dvi2rgb_0_0_ChannelBond_10 is
  port (
    ...
    pBlnkBgnFlag_reg_0 : in STD_LOGIC;
...
architecture STRUCTURE of base_dvi2rgb_0_0_ChannelBond_10 is
  ...
  attribute SOFT_HLUTNM of \pDataIn[0]_i_4__1\ : label is "soft_lutpair34";
  ...
  attribute SOFT_HLUTNM of \pDataIn[3]_i_2__1\ : label is "soft_lutpair31";
  ...
  attribute SOFT_HLUTNM of \pDataIn[5]_i_3__0\ : label is "soft_lutpair35";
...
architecture STRUCTURE of base_dvi2rgb_0_0_ChannelBond_17 is
  ...
  attribute SOFT_HLUTNM of \pDataIn[5]_i_3__1\ : label is "soft_lutpair3";
...
entity base_dvi2rgb_0_0_TWI_SlaveCtl is
  port (
    ...
    \sAddr__0\ : out STD_LOGIC_VECTOR ( 6 downto 0 );
    \FSM_onehot_sState_reg[0]\ : out STD_LOGIC;
    END_O_reg_2 : out STD_LOGIC;
    RefClk : in STD_LOGIC;
...
architecture STRUCTURE of base_dvi2rgb_0_0_TWI_SlaveCtl is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DONE_O_i_2 : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of DONE_O_i_3 : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of DONE_O_i_4 : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of END_O_i_2 : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \FSM_gray_state[0]_i_5\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_5\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_10\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_11\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_12\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_15\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_16\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_4\ : label is "soft_lutpair87";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_sState[0]_i_1\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \FSM_onehot_sState[1]_i_1\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \FSM_onehot_sState[2]_i_1\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \FSM_onehot_sState[3]_i_2\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \bitCount[1]_i_1\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \bitCount[2]_i_1\ : label is "soft_lutpair89";
  ...
  attribute SOFT_HLUTNM of \dataByte[2]_i_1\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \dataByte[3]_i_1\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \dataByte[4]_i_1\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \dataByte[5]_i_1\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \dataByte[6]_i_1\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \dataByte[7]_i_2\ : label is "soft_lutpair101";
...
\FSM_gray_state[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_gray_state[2]_i_14_n_0\,
      I2 => \FSM_gray_state[0]_i_6_n_0\,
      I3 => \FSM_gray_state[2]_i_16_n_0\,
      I4 => DONE_O_i_5_n_0,
      I5 => \FSM_gray_state[2]_i_15_n_0\,
...
\FSM_gray_state[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000100010155555"
    )
        port map (
      I0 => state(2),
      I1 => dSda,
...
\FSM_gray_state[2]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\FSM_gray_state[2]_i_14\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_gray_state[2]_i_15\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\FSM_gray_state[2]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08FFFFFF"
    )
        port map (
...
\FSM_gray_state[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\FSM_gray_state[2]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FDF1000000000000"
    )
        port map (
      I0 => DONE_O_i_3_n_0,
      I1 => state(0),
      I2 => \FSM_gray_state[2]_i_10_n_0\,
      I3 => \FSM_gray_state[2]_i_13_n_0\,
      I4 => state(2),
      I5 => state(1),
      O => \FSM_gray_state[2]_i_6_n_0\
    );
\FSM_gray_state[2]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\FSM_gray_state[2]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFFE"
    )
        port map (
...
\FSM_gray_state[2]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"10101010101010FF"
        ...
        port map (
      I0 => sI2C_RdWrn,
      I1 => \FSM_gray_state[2]_i_11_n_0\,
      I2 => \FSM_gray_state[2]_i_14_n_0\,
      I3 => \FSM_gray_state[2]_i_15_n_0\,
      I4 => DONE_O_i_5_n_0,
...
\FSM_gray_state_reg[0]_i_2\: unisim.vcomponents.MUXF7
     port map (
      I0 => \FSM_gray_state[0]_i_3_n_0\,
      I1 => \FSM_gray_state[0]_i_4_n_0\,
      O => \nstate__0\(0),
      S => \FSM_gray_state[2]_i_7_n_0\
    );
...
\FSM_gray_state_reg[2]_i_2\: unisim.vcomponents.MUXF7
     port map (
...
\FSM_onehot_sState[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFCAAAAAAA0"
    )
        port map (
      I0 => sI2C_End,
      I1 => \FSM_onehot_sState_reg[0]_0\,
      I2 => \sAddr_reg[0]\,
      I3 => \FSM_onehot_sState_reg[3]_0\,
      I4 => \sAddr_reg[0]_0\,
      I5 => sI2C_Done,
...
\sAddr[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
\sAddr[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8BB8"
    )
        port map (
...
\sAddr[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8BB8B8B8"
    )
        port map (
...
architecture STRUCTURE of base_dvi2rgb_0_0_EEPROM_8b is
  ...
  signal \sAddr[5]_i_3_n_0\ : STD_LOGIC;
  signal \sAddr__0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  attribute SOFT_HLUTNM of \sAddr[5]_i_3\ : label is "soft_lutpair102";
begin
...
I2C_SlaveController: entity work.base_dvi2rgb_0_0_TWI_SlaveCtl
     port map (
      ...
      END_O_reg_2 => I2C_SlaveController_n_13,
      \FSM_onehot_sState_reg[0]\ => I2C_SlaveController_n_12,
      \FSM_onehot_sState_reg[0]_0\ => \FSM_onehot_sState_reg_n_0_[0]\,
      ...
      RefClk => RefClk,
      sAddr(6 downto 0) => sAddr(6 downto 0),
      \sAddr__0\(6 downto 0) => \sAddr__0\(6 downto 0),
      \sAddr_reg[0]\ => \FSM_onehot_sState_reg_n_0_[2]\,
      \sAddr_reg[0]_0\ => \FSM_onehot_sState_reg_n_0_[1]\,
      \sAddr_reg[4]\ => \sAddr[4]_i_2_n_0\,
      \sAddr_reg[5]\ => \sAddr[5]_i_3_n_0\
    );
...
\sAddr[5]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
entity base_dvi2rgb_0_0 is
  ...
  attribute x_core_info of base_dvi2rgb_0_0 : entity is "dvi2rgb,Vivado 2025.1";
