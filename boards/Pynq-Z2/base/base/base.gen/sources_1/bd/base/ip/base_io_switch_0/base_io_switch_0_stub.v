...
//               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_io_switch_0/base_io_switch_0_stub.v
...
(* CHECK_LICENSE_TYPE = "base_io_switch_0,io_switch_v1_1,{}" *) (* CORE_GENERATION_INFO = "base_io_switch_0,io_switch_v1_1,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=io_switch,x_ipVersion=1.1,x_ipCoreRevision=8,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_DATA_WIDTH=32,C_S_AXI_ADDR_WIDTH=6,C_INTERFACE_TYPE=3,C_IO_SWITCH_WIDTH=20,C_NUM_PWMS=6,C_NUM_TIMERS=8,C_NUM_SS=1}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
