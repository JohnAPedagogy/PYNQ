...
-- Date        : Sun Sep 21 16:55:16 2025
-- Host        : GI240817-JohnAlamina running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_pixel_unpack_0/base_pixel_unpack_0_sim_netlist.vhdl
...
entity base_pixel_unpack_0_pixel_unpack_flow_control_loop_pipe_sequential_init is
  port (
    ...
    \mode_read_reg_218_reg[6]\ : out STD_LOGIC;
...
architecture STRUCTURE of base_pixel_unpack_0_pixel_unpack_flow_control_loop_pipe_sequential_init is
  ...
  signal \^mode_read_reg_218_reg[6]\ : STD_LOGIC;
begin
  ap_NS_fsm9 <= \^ap_ns_fsm9\;
  ap_predicate_pred299_state4_reg <= \^ap_predicate_pred299_state4_reg\;
  \mode_read_reg_218_reg[6]\ <= \^mode_read_reg_218_reg[6]\;
...
entity base_pixel_unpack_0_pixel_unpack_flow_control_loop_pipe_sequential_init_3 is
  port (
    \mode_read_reg_218_reg[1]\ : out STD_LOGIC;
    ap_rst_n_inv : in STD_LOGIC;
    ap_clk : in STD_LOGIC;
...
entity base_pixel_unpack_0_pixel_unpack_flow_control_loop_pipe_sequential_init_6 is
  port (
    ...
    \mode_read_reg_218_reg[9]\ : out STD_LOGIC;
    \mode_read_reg_218_reg[0]\ : out STD_LOGIC;
    ap_rst_n_inv : in STD_LOGIC;
    ap_clk : in STD_LOGIC;
...
architecture STRUCTURE of base_pixel_unpack_0_pixel_unpack_flow_control_loop_pipe_sequential_init_6 is
  ...
  signal \^mode_read_reg_218_reg[9]\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
...
begin
  ...
  \mode_read_reg_218_reg[9]\ <= \^mode_read_reg_218_reg[9]\;
...
entity \base_pixel_unpack_0_pixel_unpack_regslice_both__parameterized2\ is
  port (
    ...
    \mode_read_reg_218_reg[1]\ : out STD_LOGIC;
    \mode_read_reg_218_reg[0]\ : out STD_LOGIC;
    \mode_read_reg_218_reg[4]\ : out STD_LOGIC;
...
architecture STRUCTURE of \base_pixel_unpack_0_pixel_unpack_regslice_both__parameterized2\ is
  ...
  signal \^mode_read_reg_218_reg[0]\ : STD_LOGIC;
  signal \^mode_read_reg_218_reg[1]\ : STD_LOGIC;
  signal \^mode_read_reg_218_reg[4]\ : STD_LOGIC;
...
begin
  ...
  \mode_read_reg_218_reg[0]\ <= \^mode_read_reg_218_reg[0]\;
  \mode_read_reg_218_reg[1]\ <= \^mode_read_reg_218_reg[1]\;
  \mode_read_reg_218_reg[4]\ <= \^mode_read_reg_218_reg[4]\;
...
ap_predicate_pred223_state4_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
        ...
        port map (
      I0 => \^mode_read_reg_218_reg[0]\,
      I1 => ap_predicate_pred241_state4_reg(1),
      I2 => \^mode_read_reg_218_reg[4]\,
      O => \^mode_read_reg_218_reg[1]\
    );
...
ap_predicate_pred241_state4_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => \^mode_read_reg_218_reg[4]\,
      I1 => ap_predicate_pred241_state4_reg(1),
      I2 => \^mode_read_reg_218_reg[0]\,
      O => \^ap_ns_fsm7\
    );
...
architecture STRUCTURE of base_pixel_unpack_0_pixel_unpack is
  ...
  signal mode_read_reg_218 : STD_LOGIC_VECTOR ( 31 downto 0 );
...
ap_predicate_pred299_state4_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000001010105"
        ...
        port map (
      I0 => mode_read_reg_218(3),
      I1 => mode_read_reg_218(2),
      I2 => grp_pixel_unpack_Pipeline_VITIS_LOOP_85_9_fu_84_n_23,
      I3 => mode_read_reg_218(1),
      I4 => mode_read_reg_218(0),
...
grp_pixel_unpack_Pipeline_VITIS_LOOP_19_1_fu_180: entity work.base_pixel_unpack_0_pixel_unpack_pixel_unpack_Pipeline_VITIS_LOOP_19_1
     port map (
      ...
      ap_predicate_pred299_state4_i_3(25 downto 2) => mode_read_reg_218(31 downto 8),
      ap_predicate_pred299_state4_i_3(1 downto 0) => mode_read_reg_218(1 downto 0),
      ap_rst_n => ap_rst_n,
      ap_rst_n_inv => ap_rst_n_inv,
      ...
      \mode_read_reg_218_reg[0]\ => grp_pixel_unpack_Pipeline_VITIS_LOOP_19_1_fu_180_n_41,
      \mode_read_reg_218_reg[9]\ => grp_pixel_unpack_Pipeline_VITIS_LOOP_19_1_fu_180_n_38,
      stream_in_32_TLAST_int_regslice => stream_in_32_TLAST_int_regslice,
      stream_in_32_TUSER_int_regslice => stream_in_32_TUSER_int_regslice,
...
grp_pixel_unpack_Pipeline_VITIS_LOOP_40_4_fu_156: entity work.base_pixel_unpack_0_pixel_unpack_pixel_unpack_Pipeline_VITIS_LOOP_40_4
     port map (
      Q(0) => mode_read_reg_218(1),
      ...
      ap_rst_n_inv => ap_rst_n_inv,
      grp_pixel_unpack_Pipeline_VITIS_LOOP_40_4_fu_156_ap_start_reg => grp_pixel_unpack_Pipeline_VITIS_LOOP_40_4_fu_156_ap_start_reg,
      \mode_read_reg_218_reg[1]\ => grp_pixel_unpack_Pipeline_VITIS_LOOP_40_4_fu_156_n_1
    );
...
grp_pixel_unpack_Pipeline_VITIS_LOOP_51_5_fu_132: entity work.base_pixel_unpack_0_pixel_unpack_pixel_unpack_Pipeline_VITIS_LOOP_51_5
     port map (
...
grp_pixel_unpack_Pipeline_VITIS_LOOP_68_7_fu_108: entity work.base_pixel_unpack_0_pixel_unpack_pixel_unpack_Pipeline_VITIS_LOOP_68_7
     port map (
      Q(0) => mode_read_reg_218(1),
      ...
      grp_pixel_unpack_Pipeline_VITIS_LOOP_68_7_fu_108_stream_in_32_TREADY => grp_pixel_unpack_Pipeline_VITIS_LOOP_68_7_fu_108_stream_in_32_TREADY,
      in_pixel_last_reg_135 => in_pixel_last_reg_135,
      \mode_read_reg_218_reg[1]\ => grp_pixel_unpack_Pipeline_VITIS_LOOP_68_7_fu_108_n_1,
...
grp_pixel_unpack_Pipeline_VITIS_LOOP_85_9_fu_84: entity work.base_pixel_unpack_0_pixel_unpack_pixel_unpack_Pipeline_VITIS_LOOP_85_9
     port map (
      D(0) => ap_NS_fsm(3),
      Q(1) => ap_CS_fsm_state4,
      Q(0) => ap_CS_fsm_state3,
      ...
      ap_predicate_pred203_state4_reg_1(7 downto 0) => mode_read_reg_218(7 downto 0),
      ...
      grp_pixel_unpack_Pipeline_VITIS_LOOP_85_9_fu_84_ap_start_reg => grp_pixel_unpack_Pipeline_VITIS_LOOP_85_9_fu_84_ap_start_reg,
      \mode_read_reg_218_reg[6]\ => grp_pixel_unpack_Pipeline_VITIS_LOOP_85_9_fu_84_n_23,
...
\mode_read_reg_218_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(0),
      Q => mode_read_reg_218(0),
      R => '0'
    );
\mode_read_reg_218_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(10),
      Q => mode_read_reg_218(10),
      R => '0'
    );
\mode_read_reg_218_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(11),
      Q => mode_read_reg_218(11),
      R => '0'
    );
\mode_read_reg_218_reg[12]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(12),
      Q => mode_read_reg_218(12),
      R => '0'
    );
\mode_read_reg_218_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(13),
      Q => mode_read_reg_218(13),
      R => '0'
    );
\mode_read_reg_218_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(14),
      Q => mode_read_reg_218(14),
      R => '0'
    );
\mode_read_reg_218_reg[15]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(15),
      Q => mode_read_reg_218(15),
      R => '0'
    );
\mode_read_reg_218_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(16),
      Q => mode_read_reg_218(16),
      R => '0'
    );
\mode_read_reg_218_reg[17]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(17),
      Q => mode_read_reg_218(17),
      R => '0'
    );
\mode_read_reg_218_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(18),
      Q => mode_read_reg_218(18),
      R => '0'
    );
\mode_read_reg_218_reg[19]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(19),
      Q => mode_read_reg_218(19),
      R => '0'
    );
\mode_read_reg_218_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(1),
      Q => mode_read_reg_218(1),
      R => '0'
    );
\mode_read_reg_218_reg[20]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(20),
      Q => mode_read_reg_218(20),
      R => '0'
    );
\mode_read_reg_218_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(21),
      Q => mode_read_reg_218(21),
      R => '0'
    );
\mode_read_reg_218_reg[22]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(22),
      Q => mode_read_reg_218(22),
      R => '0'
    );
\mode_read_reg_218_reg[23]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(23),
      Q => mode_read_reg_218(23),
      R => '0'
    );
\mode_read_reg_218_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(24),
      Q => mode_read_reg_218(24),
      R => '0'
    );
\mode_read_reg_218_reg[25]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(25),
      Q => mode_read_reg_218(25),
      R => '0'
    );
\mode_read_reg_218_reg[26]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(26),
      Q => mode_read_reg_218(26),
      R => '0'
    );
\mode_read_reg_218_reg[27]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(27),
      Q => mode_read_reg_218(27),
      R => '0'
    );
\mode_read_reg_218_reg[28]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(28),
      Q => mode_read_reg_218(28),
      R => '0'
    );
\mode_read_reg_218_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(29),
      Q => mode_read_reg_218(29),
      R => '0'
    );
\mode_read_reg_218_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(2),
      Q => mode_read_reg_218(2),
      R => '0'
    );
\mode_read_reg_218_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(30),
      Q => mode_read_reg_218(30),
      R => '0'
    );
\mode_read_reg_218_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(31),
      Q => mode_read_reg_218(31),
      R => '0'
    );
\mode_read_reg_218_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(3),
      Q => mode_read_reg_218(3),
      R => '0'
    );
\mode_read_reg_218_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(4),
      Q => mode_read_reg_218(4),
      R => '0'
    );
\mode_read_reg_218_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(5),
      Q => mode_read_reg_218(5),
      R => '0'
    );
\mode_read_reg_218_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(6),
      Q => mode_read_reg_218(6),
      R => '0'
    );
\mode_read_reg_218_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(7),
      Q => mode_read_reg_218(7),
      R => '0'
    );
\mode_read_reg_218_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(8),
      Q => mode_read_reg_218(8),
      R => '0'
    );
\mode_read_reg_218_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_CS_fsm_state2,
      D => mode_0_data_reg(9),
      Q => mode_read_reg_218(9),
      R => '0'
    );
...
regslice_both_stream_out_24_V_data_V_U: entity work.\base_pixel_unpack_0_pixel_unpack_regslice_both__parameterized2\
     port map (
      ...
      ap_predicate_pred241_state4_reg(7 downto 0) => mode_read_reg_218(7 downto 0),
      ap_rst_n_inv => ap_rst_n_inv,
      ...
      \mode_read_reg_218_reg[0]\ => regslice_both_stream_out_24_V_data_V_U_n_11,
      \mode_read_reg_218_reg[1]\ => regslice_both_stream_out_24_V_data_V_U_n_10,
      \mode_read_reg_218_reg[4]\ => regslice_both_stream_out_24_V_data_V_U_n_12,
      stream_in_32_TLAST_int_regslice => stream_in_32_TLAST_int_regslice,
...
entity base_pixel_unpack_0 is
  ...
  attribute X_CORE_INFO of base_pixel_unpack_0 : entity is "pixel_unpack,Vivado 2025.1";
  attribute hls_module : string;
