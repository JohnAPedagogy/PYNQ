...
//               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_pixel_unpack_0/base_pixel_unpack_0_stub.v
...
(* CHECK_LICENSE_TYPE = "base_pixel_unpack_0,pixel_unpack,{}" *) (* CORE_GENERATION_INFO = "base_pixel_unpack_0,pixel_unpack,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=pixel_unpack,x_ipVersion=1.0,x_ipCoreRevision=2114269984,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=5,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "pixel_unpack,Vivado 2025.1" *) (* hls_module = "yes" *) 
module base_pixel_unpack_0(s_axi_control_ARADDR, 
