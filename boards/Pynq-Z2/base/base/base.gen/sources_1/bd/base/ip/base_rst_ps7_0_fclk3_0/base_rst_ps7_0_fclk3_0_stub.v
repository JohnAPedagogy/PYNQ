...
// Command     : write_verilog -force -mode synth_stub -rename_top base_rst_ps7_0_fclk3_0 -prefix
//               base_rst_ps7_0_fclk3_0_ base_proc_sys_reset_pixelclk_0_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN base_dvi2rgb_0_0_PixelClk, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
