...
--               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_slice_pmodb_gpio_0/base_slice_pmodb_gpio_0_stub.vhdl
...
entity base_slice_pmodb_gpio_0 is
  ...
  attribute CORE_GENERATION_INFO of base_slice_pmodb_gpio_0 : entity is "base_slice_pmodb_gpio_0,interface_slice,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=interface_slice,x_ipVersion=1.0,x_ipCoreRevision=6,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,TYPE=1,WIDTH=8}";
...
architecture stub of base_slice_pmodb_gpio_0 is
  ...
  attribute X_CORE_INFO of stub : architecture is "interface_slice,Vivado 2025.1";
begin
end;
