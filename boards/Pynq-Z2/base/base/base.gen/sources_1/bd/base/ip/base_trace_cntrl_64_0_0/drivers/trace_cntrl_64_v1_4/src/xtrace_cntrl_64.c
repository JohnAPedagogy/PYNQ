...
void XTrace_cntrl_64_Set_trigger(XTrace_cntrl_64 *InstancePtr, u64 Data) {
    ...
    XTrace_cntrl_64_WriteReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_TRIGGER_DATA, (u32)(Data));
    XTrace_cntrl_64_WriteReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_TRIGGER_DATA + 4, (u32)(Data >> 32));
}
...
u64 XTrace_cntrl_64_Get_trigger(XTrace_cntrl_64 *InstancePtr) {
    ...
    Data = XTrace_cntrl_64_ReadReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_TRIGGER_DATA);
    Data += (u64)XTrace_cntrl_64_ReadReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_TRIGGER_DATA + 4) << 32;
    return Data;
}
