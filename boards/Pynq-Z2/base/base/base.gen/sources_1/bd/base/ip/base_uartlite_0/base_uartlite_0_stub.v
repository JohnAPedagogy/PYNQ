...
// Command     : write_verilog -force -mode synth_stub -rename_top base_uartlite_0 -prefix
//               base_uartlite_0_ base_uartlite_1_stub.v
...
(* CHECK_LICENSE_TYPE = "base_uartlite_1,axi_uartlite,{}" *) (* core_generation_info = "base_uartlite_1,axi_uartlite,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_uartlite,x_ipVersion=2.0,x_ipCoreRevision=39,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_S_AXI_ACLK_FREQ_HZ=100000000,C_S_AXI_ADDR_WIDTH=4,C_S_AXI_DATA_WIDTH=32,C_BAUDRATE=9600,C_DATA_BITS=8,C_USE_PARITY=0,C_ODD_PARITY=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_uartlite,Vivado 2025.1" *) 
module base_uartlite_0(s_axi_aclk, s_axi_aresetn, interrupt, 
