...
--               c:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.gen/sources_1/bd/base/ip/base_v_axi4s_vid_out_0_0/base_v_axi4s_vid_out_0_0_stub.vhdl
...
entity base_v_axi4s_vid_out_0_0 is
  ...
  attribute CORE_GENERATION_INFO of base_v_axi4s_vid_out_0_0 : entity is "base_v_axi4s_vid_out_0_0,v_axi4s_vid_out_v4_0_20,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_axi4s_vid_out,x_ipVersion=4.0,x_ipCoreRevision=20,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_PIXELS_PER_CLOCK=1,C_COMPONENTS_PER_PIXEL=3,C_S_AXIS_COMPONENT_WIDTH=8,C_NATIVE_COMPONENT_WIDTH=8,C_NATIVE_DATA_WIDTH=24,C_S_AXIS_TDATA_WIDTH=24,C_HAS_ASYNC_CLK=1,C_ADDR_WIDTH=11,C_VTG_MASTER_SLAVE=1,C_HYSTERESIS_LEVEL=1024,C_SYNC_LOCK_THRESHOLD=4,C_INCLUDE_PIXEL_REPEAT=0,C_INCLUDE_PIXEL_REMAP_420=0,C_ADDR_WIDTH_PIXEL_REMAP_420=10,C_ARBITRARY_RES_EN=0}";
...
architecture stub of base_v_axi4s_vid_out_0_0 is
  ...
  attribute X_CORE_INFO of stub : architecture is "v_axi4s_vid_out_v4_0_20,Vivado 2025.1";
begin
end;
