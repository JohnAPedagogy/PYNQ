...
reg   [15:0] out_data_2_reg_140;
wire   [23:0] zext_ln76_fu_116_p1;
wire   [23:0] zext_ln76_1_fu_131_p1;
wire   [15:0] out_data_fu_112_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        in_pixel_last_reg_135 <= stream_in_32_TLAST;
        out_data_2_reg_140 <= {{stream_in_32_TDATA[31:16]}};
    end
end
...
always @ (*) begin
    if (((in_pixel_last_reg_135 == 1'd1) & (1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
        stream_out_24_TDATA = zext_ln76_1_fu_131_p1;
    end else if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        stream_out_24_TDATA = zext_ln76_fu_116_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
        stream_out_24_TLAST = in_pixel_last_reg_135;
    end else if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign out_data_fu_112_p1 = stream_in_32_TDATA[15:0];

assign stream_out_24_TKEEP = 'bx;

assign stream_out_24_TSTRB = 'bx;

assign zext_ln76_1_fu_131_p1 = out_data_2_reg_140;

assign zext_ln76_fu_116_p1 = out_data_fu_112_p1;
