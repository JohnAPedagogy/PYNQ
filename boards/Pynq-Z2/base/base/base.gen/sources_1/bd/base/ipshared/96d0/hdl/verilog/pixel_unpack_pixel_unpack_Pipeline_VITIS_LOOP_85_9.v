...
reg   [7:0] tmp_1_reg_168;
wire   [7:0] tmp_3_fu_126_p3;
reg   [7:0] tmp_3_reg_173;
reg   [7:0] tmp_7_reg_178;
wire   [23:0] out_data_fu_138_p3;
wire   [23:0] out_data_1_fu_155_p4;
wire   [15:0] trunc_ln95_fu_134_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        in_pixel_last_reg_163 <= stream_in_32_TLAST;
        tmp_1_reg_168 <= {{stream_in_32_TDATA[15:8]}};
        tmp_3_reg_173 <= {{stream_in_32_TDATA[31:24]}};
        tmp_7_reg_178 <= {{stream_in_32_TDATA[23:16]}};
    end
end
...
always @ (*) begin
    if (((in_pixel_last_reg_163 == 1'd1) & (1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
        stream_out_24_TDATA = out_data_1_fu_155_p4;
    end else if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        stream_out_24_TDATA = out_data_fu_138_p3;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
        stream_out_24_TLAST = in_pixel_last_reg_163;
    end else if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign out_data_1_fu_155_p4 = {{{tmp_3_reg_173}, {tmp_1_reg_168}}, {tmp_7_reg_178}};

assign out_data_fu_138_p3 = {{tmp_3_fu_126_p3}, {trunc_ln95_fu_134_p1}};

assign stream_out_24_TKEEP = 'bx;

assign stream_out_24_TSTRB = 'bx;

assign tmp_3_fu_126_p3 = {{stream_in_32_TDATA[31:24]}};

assign trunc_ln95_fu_134_p1 = stream_in_32_TDATA[15:0];
