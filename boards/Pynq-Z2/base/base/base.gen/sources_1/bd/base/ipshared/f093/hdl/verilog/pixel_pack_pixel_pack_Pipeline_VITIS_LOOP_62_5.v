...
wire    ap_loop_init;
reg   [0:0] ap_phi_mux_last_6_31215_phi_fu_177_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ...
        last_4_reg_114 <= ap_phi_mux_last_6_31215_phi_fu_177_p4;
    end
end
...
always @ (*) begin
    if (((last_4_reg_114 == 1'd0) & (delayed_last_reg_103 == 1'd0))) begin
        ap_phi_mux_last_6_31215_phi_fu_177_p4 = ap_phi_mux_last_6_3_ph_phi_fu_158_p8;
    end else begin
        ap_phi_mux_last_6_31215_phi_fu_177_p4 = 1'd1;
    end
end
