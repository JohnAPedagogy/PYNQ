...
module pixel_pack_pixel_pack_Pipeline_VITIS_LOOP_84_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] in_pixel_last_fu_106_p1;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    stream_in_24_TDATA_blk_n;
reg    stream_out_32_TDATA_blk_n;
reg   [0:0] empty_reg_130_3;
reg    ap_block_state1_pp0_stage0_iter0;
wire   [15:0] trunc_ln92_fu_95_p1;
reg   [15:0] trunc_ln92_reg_135;
wire   [15:0] trunc_ln92_1_fu_118_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        empty_reg_130_3 <= stream_in_24_TUSER;
        trunc_ln92_reg_135 <= trunc_ln92_fu_95_p1;
    end
end
...
always @ (*) begin
    if (((in_pixel_last_fu_106_p1 == 1'd1) & (1'b0 == ap_block_state2_pp0_stage1_iter0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign in_pixel_last_fu_106_p1 = stream_in_24_TLAST;

assign stream_out_32_TDATA = {{trunc_ln92_1_fu_118_p1}, {trunc_ln92_reg_135}};
...
assign stream_out_32_TUSER = (stream_in_24_TUSER | empty_reg_130_3);

assign trunc_ln92_1_fu_118_p1 = stream_in_24_TDATA[15:0];

assign trunc_ln92_fu_95_p1 = stream_in_24_TDATA[15:0];

endmodule //pixel_pack_pixel_pack_Pipeline_VITIS_LOOP_84_7
