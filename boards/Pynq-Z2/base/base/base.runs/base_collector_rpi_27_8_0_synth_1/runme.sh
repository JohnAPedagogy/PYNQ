...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_collector_rpi_27_8_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_collector_rpi_27_8_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_collector_rpi_27_8_0.tcl
