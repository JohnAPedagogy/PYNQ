...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_color_swap_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_color_swap_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_color_swap_0_0.tcl
