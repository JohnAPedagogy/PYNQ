...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_dff_en_reset_vector_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_dff_en_reset_vector_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_dff_en_reset_vector_0_1.tcl
