...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_dlmb_v10_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_dlmb_v10_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_dlmb_v10_3.tcl
