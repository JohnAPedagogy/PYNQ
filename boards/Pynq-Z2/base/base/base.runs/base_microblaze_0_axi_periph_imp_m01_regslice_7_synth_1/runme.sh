...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_microblaze_0_axi_periph_imp_m01_regslice_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_microblaze_0_axi_periph_imp_m01_regslice_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_microblaze_0_axi_periph_imp_m01_regslice_7.tcl
