...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_microblaze_0_axi_periph_imp_m08_regslice_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_microblaze_0_axi_periph_imp_m08_regslice_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_microblaze_0_axi_periph_imp_m08_regslice_3.tcl
