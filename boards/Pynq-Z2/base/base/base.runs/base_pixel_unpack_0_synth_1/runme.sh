...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_pixel_unpack_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_pixel_unpack_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_pixel_unpack_0.tcl
