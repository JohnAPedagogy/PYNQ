...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_ps7_0_axi_periph_imp_m07_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ps7_0_axi_periph_imp_m07_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ps7_0_axi_periph_imp_m07_regslice_0.tcl
