...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_rst_clk_wiz_1_100M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_rst_clk_wiz_1_100M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_rst_clk_wiz_1_100M_2.tcl
