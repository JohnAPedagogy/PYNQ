...
HD_PWD='C:/work/dev/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_uartlite_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_uartlite_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_uartlite_1.tcl
